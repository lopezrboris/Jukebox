...
{
    class AudioTapeSelectorService : ISelectorService
    {
        ...
        public AudioTapeSelectorService(IConfigurationService configurationService)
        {
        ...
        public Enums.EDeviceStatus PrepareSelector()
        {
            try
            {
                ...
                Console.WriteLine(@"Selected changed to {0} media type.", _currentAlbum.Media.GetMediaType());
